...
# ── Utilidades (compartidas con generar_categorias.py vía boe_utils) ─────────

import boe_utils
from boe_utils import (
    _parse_fecha, formatear_fecha, parsear_resumen, extraer_organismo,
    ref_boe_desde_enlace, generar_slug,
)


def url_convocatoria(titulo, enlace_boe):
    """Devuelve la URL en oponoticias.com si existe la página, si no el BOE."""
    return boe_utils.url_convocatoria(titulo, enlace_boe, CONVOCATORIA_DIR)
